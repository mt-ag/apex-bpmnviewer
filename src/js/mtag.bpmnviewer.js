...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var bpmn_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! bpmn-js */ "./node_modules/bpmn-js/index.js");
	...
	var originalBounds = {isExpanded: false, width: 0, height: 0,  x: 0, y: 0};
		...
		eventBus.on('element.click', function(event) {
			if (event.element.type == "bpmn:SubProcess") {
				...
				if (subElements.subProcs != 0) {
					if (!originalBounds.isExpanded) {
						originalBounds = getOriginalBounds(subElements);
						currentExpandedProcess = subElements.parentElement;
						originalBounds.isExpanded = true;
						...
						originalBounds.isExpanded = false;
						setBoxBounds(subElements, originalBounds);
	...
	function calculateCorrectBounds(subElements) {
		...
		var centerExtremeX = Math.abs((maxX + minX) / 2);
		var centerExtremeY = Math.abs((maxY + minY) / 2);
	...
	function getOriginalBounds(subElements) {
		var originalBounds = {width: 0, height: 0,  x: 0, y: 0};
		...
		if (shapeElement) {
			...
			//store original data
			originalBounds.width = rectElement[0].getAttribute("width");
			originalBounds.height = rectElement[0].getAttribute("height");
		}
...
module.exports = __webpack_require__(/*! /Users/moklein/Documents/git/github/bpmn-viewer/index.js */"./index.js");
